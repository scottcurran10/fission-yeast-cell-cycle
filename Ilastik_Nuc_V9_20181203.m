...
%load files
namefrag='sc333 rum1-mNG';
indir='/Volumes/SCOTT2/cut11-mCh analysis and derivative/Widefield cut11-mCh/August 2018/rum1/NNseg/MATLAB nucV9/';
...
minsize=1000;
pixelsize=0.0651;
bin_min=0; bin_max=20; bin_step=0.5;
background_value=570.434346; %change if not wildtype
