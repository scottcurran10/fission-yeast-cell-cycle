...
%load files
namefrag='sc413 cdc25-mNG cdc10-V50 7h';
indir='/Volumes/SCOTT2/Cdc25 PAPER 2022/cdc25-mNG into G1 block 190522/sc413 cdc25-mNG cdc10-V50/7h/';
...
minsize=1000;
pixelsize=0.0651;
bin_min=0; bin_max=50; bin_step=0.25;
background_value= 604.0975771; %change if not wildtype
